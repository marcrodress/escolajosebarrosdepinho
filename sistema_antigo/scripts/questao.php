...
echo "<script language='javascript'>window.location='?p=6&turma=$turma&documento=$documento&tipo_envio=$tipo_envio&code_atividade=$code_atividade&total=$total&atual=$atual&type=$tipo_envios';</script>";
