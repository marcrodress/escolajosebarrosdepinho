...
<table width="550" border="0">
  <tr>
    <td colspan="2" style="padding:5px;" bgcolor="#99CC00"><strong>OBJETIVO</strong></td>
  </tr>
  <tr>
    <td colspan="2"><label for="objetivo"></label>
    <input name="objetivo" type="text" id="objetivo" value="<? echo $res_verifica['objetivo']; ?>" size="72"></td>
  </tr>
  <tr>
    <td width="264" style="padding:5px;" bgcolor="#99CC00"><strong>DATA DA ENTREGA</strong></td>
  ...
  <tr>
    <td colspan="2" style="padding:5px;" bgcolor="#99CC00"><strong>VÍDEO EXPLICATIVO 1</strong></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="2" style="padding:5px;" bgcolor="#99CC00"><strong>V&Iacute;DEO EXPLICATIVO 2</strong></td>
  </tr>
  <tr>
    <td colspan="2"><input name="video2" type="text" id="video2" size="72" value="<? echo $res_verifica['video2']; ?>" /></td>
  </tr>
  <tr>
    <td colspan="2" style="padding:5px;" bgcolor="#99CC00"><strong>V&Iacute;DEO EXPLICATIVO 3</strong></td>
  </tr>
  <tr>
    <td colspan="2"><input name="video3" type="text" id="video3" size="72" value="<? echo $res_verifica['video3']; ?>" /></td>
  </tr>
  <tr>
    <td colspan="2" bgcolor="#99CC00"><strong>LINK EXTERNO</strong></td>
  </tr>
  <tr>
    <td colspan="2"><input name="link_externo" type="text" size="72" value="<? echo $res_verifica['link_externo']; ?>" /></td>
  </tr>
  <tr>
    <td style="padding:5px;" bgcolor="#99CC00"><strong>DESEJA INCLUIR ARQUIVO COMPLEMENTAR?</strong></td>
    <td style="padding:5px;" bgcolor="#99CC00"><strong>COMO SER&Aacute; O ENVIO DA ATIVIDADE</strong>?</td>
  </tr>
  <tr>
    <td>N&Atilde;O<input name="documento" type="radio" id="radio5" value="NAO" <? if($res_verifica['arq_complementar'] == 'NAO'){ ?> checked> <? } ?>
  ...
  <tr>
    <td align="center" style="padding:5px;" colspan="2"><input style="font:12px Arial, Helvetica, sans-serif; padding:10px;" type="submit" name="button" id="button" value="Avançar"></td>
  </tr>
</table>
</form>
<? } ?>
