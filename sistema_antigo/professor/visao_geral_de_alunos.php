    ...
    <div class="container">
      ...
      <? $turma = 0;
		$sql_aluno = mysqli_query($conexao_bd, "SELECT * FROM alunos WHERE code_aluno = '".$_GET['aluno']."'");
	     while($res_aluno = mysqli_fetch_array($sql_aluno)){ $turma = $res_aluno['turma'];
	  ?>
      <div class="row">
        <div class="col-1">
        ...
        <div class="col">
          <h2 style="margin:0 0 0 10px;"><strong><? echo strtoupper($res_aluno['nome_aluno']); ?></strong></h2>
          <?
          ...
          <h5 style="margin:0 0 0 10px;" class="text-primary">Ano: <? echo $res_turma['code_serie']; ?>° ano Turma: <? echo $res_turma['tipo_turma']; ?> Turno: <? echo $res_turma['turno']; ?> <br />
			  <strong  class="text-warning">Participação: <?
				 ...
				 $conta_atividades = mysqli_num_rows(mysqli_query($conexao_bd, "SELECT * FROM atividades WHERE turma = '".$res_aluno['turma']."' AND code_dia_atividade < '$code_hoje'"));
      ...
      <hr />
      <h4 style="color:#F00;"><strong>Frequência</strong></h4>
      <hr />
          ...
          <tbody>
            <tr>
              <th scope="row"><strong style="font:12px Arial, Helvetica, sans-serif; text-align:center;"><strong>3&deg; Bimestre</strong></strong></th>
				...
				?>
                <a rel="superbox[iframe][1000x600]" href="scripts/mostrar_relatorio_atividades.php?periodo=3&aluno=<? echo $_GET['aluno']; ?>&componente=96514&turma=<? echo $turma; ?>"><? echo $conta; ?>%</a>
                </th>
              <th scope="col"><?
				 $sql_atividades = mysqli_query($conexao_bd, "SELECT * FROM atividades WHERE periodo = '3' AND componente = '96461' AND turma = '$turma' AND code_dia_atividade < '$code_hoje'");
				 $conta_atividades = mysqli_num_rows($sql_atividades);
				 $conta_atividades_enviadas = 0;
				  while($res_atividades = mysqli_fetch_array($sql_atividades)){
				 ...
				 $sql_atividades_enviadas = mysqli_query($conexao_bd, "SELECT * FROM atividades_enviadas WHERE code_aluno = '".$_GET['aluno']."' AND code_atividade = '".$res_atividades['code_atividade']."' AND data != ''");
				  ...
				  $conta = number_format(($conta_atividades_enviadas*100)/$conta_atividades,1);
				?>
                <a rel="superbox[iframe][1000x600]" href="scripts/mostrar_relatorio_atividades.php?periodo=3&aluno=<? echo $_GET['aluno']; ?>&componente=96461&turma=<? echo $turma; ?>"><? echo $conta; ?>%</a>
              </th>
              <th scope="col"><?
				 $sql_atividades = mysqli_query($conexao_bd, "SELECT * FROM atividades WHERE periodo = '3' AND componente = '390341' AND turma = '$turma' AND code_dia_atividade < '$code_hoje'");
				 $conta_atividades = mysqli_num_rows($sql_atividades);
				 $conta_atividades_enviadas = 0;
				  while($res_atividades = mysqli_fetch_array($sql_atividades)){
				 ...
				 $sql_atividades_enviadas = mysqli_query($conexao_bd, "SELECT * FROM atividades_enviadas WHERE code_aluno = '".$_GET['aluno']."' AND code_atividade = '".$res_atividades['code_atividade']."' AND data != ''");
				  ...
				  $conta = number_format(($conta_atividades_enviadas*100)/$conta_atividades,1);
				?>
                <a rel="superbox[iframe][1000x600]" href="scripts/mostrar_relatorio_atividades.php?periodo=3&aluno=<? echo $_GET['aluno']; ?>&componente=390341&turma=<? echo $turma; ?>"><? echo $conta; ?>%</a>
              </th>
              <th scope="col"><?
				 $sql_atividades = mysqli_query($conexao_bd, "SELECT * FROM atividades WHERE periodo = '3' AND componente = '99981' AND turma = '$turma' AND code_dia_atividade < '$code_hoje'");
				 $conta_atividades = mysqli_num_rows($sql_atividades);
				 $conta_atividades_enviadas = 0;
				  while($res_atividades = mysqli_fetch_array($sql_atividades)){
				 ...
				 $sql_atividades_enviadas = mysqli_query($conexao_bd, "SELECT * FROM atividades_enviadas WHERE code_aluno = '".$_GET['aluno']."' AND code_atividade = '".$res_atividades['code_atividade']."' AND data != ''");
				  ...
				  $conta = number_format(($conta_atividades_enviadas*100)/$conta_atividades,1);
				?>
                <a rel="superbox[iframe][1000x600]" href="scripts/mostrar_relatorio_atividades.php?periodo=3&aluno=<? echo $_GET['aluno']; ?>&componente=99981&turma=<? echo $turma; ?>"><? echo $conta; ?>%</a>
              </th>
              <th scope="col"><?
				 $sql_atividades = mysqli_query($conexao_bd, "SELECT * FROM atividades WHERE periodo = '3' AND componente = '639811' AND turma = '$turma' AND code_dia_atividade < '$code_hoje'");
				 $conta_atividades = mysqli_num_rows($sql_atividades);
				 $conta_atividades_enviadas = 0;
				  while($res_atividades = mysqli_fetch_array($sql_atividades)){
				 ...
				 $sql_atividades_enviadas = mysqli_query($conexao_bd, "SELECT * FROM atividades_enviadas WHERE code_aluno = '".$_GET['aluno']."' AND code_atividade = '".$res_atividades['code_atividade']."' AND data != ''");
				  ...
				  $conta = number_format(($conta_atividades_enviadas*100)/$conta_atividades,1);
				?>
                <a rel="superbox[iframe][1000x600]" href="scripts/mostrar_relatorio_atividades.php?periodo=3&aluno=<? echo $_GET['aluno']; ?>&componente=639811&turma=<? echo $turma; ?>"><? echo $conta; ?>%</a>
              </th>
              <th scope="col"><?
				 $sql_atividades = mysqli_query($conexao_bd, "SELECT * FROM atividades WHERE periodo = '3' AND componente = '95616' AND turma = '$turma' AND code_dia_atividade < '$code_hoje'");
				 $conta_atividades = mysqli_num_rows($sql_atividades);
				 $conta_atividades_enviadas = 0;
				  while($res_atividades = mysqli_fetch_array($sql_atividades)){
				 ...
				 $sql_atividades_enviadas = mysqli_query($conexao_bd, "SELECT * FROM atividades_enviadas WHERE code_aluno = '".$_GET['aluno']."' AND code_atividade = '".$res_atividades['code_atividade']."' AND data != ''");
				  ...
				  $conta = number_format(($conta_atividades_enviadas*100)/$conta_atividades,1);
				?>
                <a rel="superbox[iframe][1000x600]" href="scripts/mostrar_relatorio_atividades.php?periodo=3&aluno=<? echo $_GET['aluno']; ?>&componente=95616&turma=<? echo $turma; ?>"><? echo $conta; ?>%</a>
              </th>
              <th scope="col"><?
				 $sql_atividades = mysqli_query($conexao_bd, "SELECT * FROM atividades WHERE periodo = '3' AND componente = '9621345' AND turma = '$turma' AND code_dia_atividade < '$code_hoje'");
				 $conta_atividades = mysqli_num_rows($sql_atividades);
				 $conta_atividades_enviadas = 0;
				  while($res_atividades = mysqli_fetch_array($sql_atividades)){
				 ...
				 $sql_atividades_enviadas = mysqli_query($conexao_bd, "SELECT * FROM atividades_enviadas WHERE code_aluno = '".$_GET['aluno']."' AND code_atividade = '".$res_atividades['code_atividade']."' AND data != ''");
				  ...
				  $conta = number_format(($conta_atividades_enviadas*100)/$conta_atividades,1);
				?>
                <a rel="superbox[iframe][1000x600]" href="scripts/mostrar_relatorio_atividades.php?periodo=3&aluno=<? echo $_GET['aluno']; ?>&componente=9621345&turma=<? echo $turma; ?>"><? echo $conta; ?>%</a>
              </th>
              <th scope="col"><?
				 $sql_atividades = mysqli_query($conexao_bd, "SELECT * FROM atividades WHERE periodo = '3' AND componente = '74235' AND turma = '$turma' AND code_dia_atividade < '$code_hoje'");
				 $conta_atividades = mysqli_num_rows($sql_atividades);
				 $conta_atividades_enviadas = 0;
				  while($res_atividades = mysqli_fetch_array($sql_atividades)){
				 ...
				 $sql_atividades_enviadas = mysqli_query($conexao_bd, "SELECT * FROM atividades_enviadas WHERE code_aluno = '".$_GET['aluno']."' AND code_atividade = '".$res_atividades['code_atividade']."' AND data != ''");
				  ...
				  $conta = number_format(($conta_atividades_enviadas*100)/$conta_atividades,1);
				?>
                <a rel="superbox[iframe][1000x600]" href="scripts/mostrar_relatorio_atividades.php?periodo=3&aluno=<? echo $_GET['aluno']; ?>&componente=74235&turma=<? echo $turma; ?>"><? echo $conta; ?>%</a>
              </th>
              <th width="65" scope="col"><?
				 $sql_atividades = mysqli_query($conexao_bd, "SELECT * FROM atividades WHERE periodo = '3' AND componente = '36244' AND turma = '$turma' AND code_dia_atividade < '$code_hoje'");
				 $conta_atividades = mysqli_num_rows($sql_atividades);
				 $conta_atividades_enviadas = 0;
				  while($res_atividades = mysqli_fetch_array($sql_atividades)){
				 ...
				 $sql_atividades_enviadas = mysqli_query($conexao_bd, "SELECT * FROM atividades_enviadas WHERE code_aluno = '".$_GET['aluno']."' AND code_atividade = '".$res_atividades['code_atividade']."' AND data != ''");
				  ...
				  $conta = number_format(($conta_atividades_enviadas*100)/$conta_atividades,1);
				?>
                <a rel="superbox[iframe][1000x600]" href="scripts/mostrar_relatorio_atividades.php?periodo=3&aluno=<? echo $_GET['aluno']; ?>&componente=36244&turma=<? echo $turma; ?>"><? echo $conta; ?>%</a>
              </th>
            ...
            <tr>
              ...
              <th scope="col"><?
				 ...
				 $sql_atividades_enviadas = mysqli_query($conexao_bd, "SELECT * FROM atividades_enviadas WHERE code_aluno = '".$_GET['aluno']."' AND code_atividade = '".$res_atividades['code_atividade']."' AND data != ''");
				  ...
				  $conta = number_format(($conta_atividades_enviadas*100)/$conta_atividades,1);
				?>
                <a rel="superbox[iframe][1000x600]" href="scripts/mostrar_relatorio_atividades.php?periodo=4&aluno=<? echo $_GET['aluno']; ?>&componente=96514&turma=<? echo $turma; ?>"><? echo $conta; ?>%</a>
              </th>
              <th scope="col"><?
				 $sql_atividades = mysqli_query($conexao_bd, "SELECT * FROM atividades WHERE periodo = '4' AND componente = '96461' AND turma = '$turma' AND code_dia_atividade < '$code_hoje'");
				 $conta_atividades = mysqli_num_rows($sql_atividades);
				 $conta_atividades_enviadas = 0;
				  while($res_atividades = mysqli_fetch_array($sql_atividades)){
				 ...
				 $sql_atividades_enviadas = mysqli_query($conexao_bd, "SELECT * FROM atividades_enviadas WHERE code_aluno = '".$_GET['aluno']."' AND code_atividade = '".$res_atividades['code_atividade']."' AND data != ''");
				  ...
				  $conta = number_format(($conta_atividades_enviadas*100)/$conta_atividades,1);
				?>
                <a rel="superbox[iframe][1000x600]" href="scripts/mostrar_relatorio_atividades.php?periodo=4&aluno=<? echo $_GET['aluno']; ?>&componente=96461&turma=<? echo $turma; ?>"><? echo $conta; ?>%</a>
              </th>
              <th scope="col"><?
				 $sql_atividades = mysqli_query($conexao_bd, "SELECT * FROM atividades WHERE periodo = '4' AND componente = '390341' AND turma = '$turma' AND code_dia_atividade < '$code_hoje'");
				 $conta_atividades = mysqli_num_rows($sql_atividades);
				 $conta_atividades_enviadas = 0;
				  while($res_atividades = mysqli_fetch_array($sql_atividades)){
				 ...
				 $sql_atividades_enviadas = mysqli_query($conexao_bd, "SELECT * FROM atividades_enviadas WHERE code_aluno = '".$_GET['aluno']."' AND code_atividade = '".$res_atividades['code_atividade']."' AND data != ''");
				  ...
				  $conta = number_format(($conta_atividades_enviadas*100)/$conta_atividades,1);
				?>
                <a rel="superbox[iframe][1000x600]" href="scripts/mostrar_relatorio_atividades.php?periodo=4&aluno=<? echo $_GET['aluno']; ?>&componente=390341&turma=<? echo $turma; ?>"><? echo $conta; ?>%</a>
              </th>
              <th scope="col"><?
				 $sql_atividades = mysqli_query($conexao_bd, "SELECT * FROM atividades WHERE periodo = '4' AND componente = '99981' AND turma = '$turma' AND code_dia_atividade < '$code_hoje'");
				 $conta_atividades = mysqli_num_rows($sql_atividades);
				 $conta_atividades_enviadas = 0;
				  while($res_atividades = mysqli_fetch_array($sql_atividades)){
				 ...
				 $sql_atividades_enviadas = mysqli_query($conexao_bd, "SELECT * FROM atividades_enviadas WHERE code_aluno = '".$_GET['aluno']."' AND code_atividade = '".$res_atividades['code_atividade']."' AND data != ''");
				  ...
				  $conta = number_format(($conta_atividades_enviadas*100)/$conta_atividades,1);
				?>
                <a rel="superbox[iframe][1000x600]" href="scripts/mostrar_relatorio_atividades.php?periodo=4&aluno=<? echo $_GET['aluno']; ?>&componente=99981&turma=<? echo $turma; ?>"><? echo $conta; ?>%</a>
              </th>
              <th scope="col"><?
				 $sql_atividades = mysqli_query($conexao_bd, "SELECT * FROM atividades WHERE periodo = '4' AND componente = '639811' AND turma = '$turma' AND code_dia_atividade < '$code_hoje'");
				 $conta_atividades = mysqli_num_rows($sql_atividades);
				 $conta_atividades_enviadas = 0;
				  while($res_atividades = mysqli_fetch_array($sql_atividades)){
				 ...
				 $sql_atividades_enviadas = mysqli_query($conexao_bd, "SELECT * FROM atividades_enviadas WHERE code_aluno = '".$_GET['aluno']."' AND code_atividade = '".$res_atividades['code_atividade']."' AND data != ''");
				  ...
				  $conta = number_format(($conta_atividades_enviadas*100)/$conta_atividades,1);
				?>
                <a rel="superbox[iframe][1000x600]" href="scripts/mostrar_relatorio_atividades.php?periodo=4&aluno=<? echo $_GET['aluno']; ?>&componente=639811&turma=<? echo $turma; ?>"><? echo $conta; ?>%</a>
              </th>
              <th scope="col"><?
				 $sql_atividades = mysqli_query($conexao_bd, "SELECT * FROM atividades WHERE periodo = '4' AND componente = '95616' AND turma = '$turma' AND code_dia_atividade < '$code_hoje'");
				 $conta_atividades = mysqli_num_rows($sql_atividades);
				 $conta_atividades_enviadas = 0;
				  while($res_atividades = mysqli_fetch_array($sql_atividades)){
				 ...
				 $sql_atividades_enviadas = mysqli_query($conexao_bd, "SELECT * FROM atividades_enviadas WHERE code_aluno = '".$_GET['aluno']."' AND code_atividade = '".$res_atividades['code_atividade']."' AND data != ''");
				  ...
				  $conta = number_format(($conta_atividades_enviadas*100)/$conta_atividades,1);
				?>
                <a rel="superbox[iframe][1000x600]" href="scripts/mostrar_relatorio_atividades.php?periodo=4&aluno=<? echo $_GET['aluno']; ?>&componente=95616&turma=<? echo $turma; ?>"><? echo $conta; ?>%</a>
              </th>
              <th scope="col"><?
				 $sql_atividades = mysqli_query($conexao_bd, "SELECT * FROM atividades WHERE periodo = '4' AND componente = '9621345' AND turma = '$turma' AND code_dia_atividade < '$code_hoje'");
				 $conta_atividades = mysqli_num_rows($sql_atividades);
				 $conta_atividades_enviadas = 0;
				  while($res_atividades = mysqli_fetch_array($sql_atividades)){
				 ...
				 $sql_atividades_enviadas = mysqli_query($conexao_bd, "SELECT * FROM atividades_enviadas WHERE code_aluno = '".$_GET['aluno']."' AND code_atividade = '".$res_atividades['code_atividade']."'");
				  ...
				  $conta = number_format(($conta_atividades_enviadas*100)/$conta_atividades,1);
				?>
                <a rel="superbox[iframe][1000x600]" href="scripts/mostrar_relatorio_atividades.php?periodo=4&aluno=<? echo $_GET['aluno']; ?>&componente=9621345&turma=<? echo $turma; ?>"><? echo $conta; ?>%</a>
              </th>
              <th scope="col"><?
				 $sql_atividades = mysqli_query($conexao_bd, "SELECT * FROM atividades WHERE periodo = '4' AND componente = '74235' AND turma = '$turma' AND code_dia_atividade < '$code_hoje'");
				 $conta_atividades = mysqli_num_rows($sql_atividades);
				 $conta_atividades_enviadas = 0;
				  while($res_atividades = mysqli_fetch_array($sql_atividades)){
				 ...
				 $sql_atividades_enviadas = mysqli_query($conexao_bd, "SELECT * FROM atividades_enviadas WHERE code_aluno = '".$_GET['aluno']."' AND code_atividade = '".$res_atividades['code_atividade']."' AND data != ''");
				  ...
				  $conta = number_format(($conta_atividades_enviadas*100)/$conta_atividades,1);
				?>
               <a rel="superbox[iframe][1000x600]" href="scripts/mostrar_relatorio_atividades.php?periodo=4&aluno=<? echo $_GET['aluno']; ?>&componente=74235&turma=<? echo $turma; ?>"><? echo $conta; ?>%</a>
              </th>
              <th scope="col"><?
				 $sql_atividades = mysqli_query($conexao_bd, "SELECT * FROM atividades WHERE periodo = '4' AND componente = '36244' AND turma = '$turma' AND code_dia_atividade < '$code_hoje'");
				 $conta_atividades = mysqli_num_rows($sql_atividades);
				 $conta_atividades_enviadas = 0;
				  while($res_atividades = mysqli_fetch_array($sql_atividades)){
				 ...
				 $sql_atividades_enviadas = mysqli_query($conexao_bd, "SELECT * FROM atividades_enviadas WHERE code_aluno = '".$_GET['aluno']."' AND code_atividade = '".$res_atividades['code_atividade']."' AND data != ''");
				  ...
				  $conta = number_format(($conta_atividades_enviadas*100)/$conta_atividades,1);
				?>
                <a rel="superbox[iframe][1000x600]" href="scripts/mostrar_relatorio_atividades.php?periodo=4&aluno=<? echo $_GET['aluno']; ?>&componente=36244&turma=<? echo $turma; ?>"><? echo $conta; ?>%</a>
              </th>
         </table>
      ...
      <table style="text-align:center; font:12px Arial, Helvetica, sans-serif;" class="table table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <th scope="col"><?
					$sql_notas = mysqli_query($conexao_bd, "SELECT * FROM notas_bimestrais WHERE aluno = '".$_GET['aluno']."' AND componente = '96461' AND bimestre = '3'");
					  while($res_notas_bimestrais = mysqli_fetch_array($sql_notas)){
						  $media = number_format(($res_notas_bimestrais['at']+$res_notas_bimestrais['ap']+$res_notas_bimestrais['ab'])/3);
                ...
                <a rel="superbox[iframe][440x120]" href="scripts/detalhes_nota.php?aluno=<? echo $_GET['aluno']; ?>&amp;bimestre=3&amp;componente=96514"><? echo number_format($media);echo ",0"; $media = 0; ?></a></th>
                <th scope="col"><?
					$sql_notas = mysqli_query($conexao_bd, "SELECT * FROM notas_bimestrais WHERE aluno = '".$_GET['aluno']."' AND componente = '390341' AND bimestre = '3'");
					  while($res_notas_bimestrais = mysqli_fetch_array($sql_notas)){
						  $media = number_format(($res_notas_bimestrais['at']+$res_notas_bimestrais['ap']+$res_notas_bimestrais['ab'])/3);
                ...
                <a rel="superbox[iframe][440x120]" href="scripts/detalhes_nota.php?aluno=<? echo $_GET['aluno']; ?>&amp;bimestre=3&amp;componente=96514"><? echo number_format($media);echo ",0"; $media = 0; ?></a></th>
                <th scope="col"><?
					$sql_notas = mysqli_query($conexao_bd, "SELECT * FROM notas_bimestrais WHERE aluno = '".$_GET['aluno']."' AND componente = '639811' AND bimestre = '3'");
					  while($res_notas_bimestrais = mysqli_fetch_array($sql_notas)){
						  $media = number_format(($res_notas_bimestrais['at']+$res_notas_bimestrais['ap']+$res_notas_bimestrais['ab'])/3);
                ...
                <a rel="superbox[iframe][440x120]" href="scripts/detalhes_nota.php?aluno=<? echo $_GET['aluno']; ?>&amp;bimestre=3&amp;componente=96514"><? echo number_format($media);echo ",0"; $media = 0; ?></a></th>
                <th scope="col"><?
					$sql_notas = mysqli_query($conexao_bd, "SELECT * FROM notas_bimestrais WHERE aluno = '".$_GET['aluno']."' AND componente = '95616' AND bimestre = '3'");
					  while($res_notas_bimestrais = mysqli_fetch_array($sql_notas)){
						  $media = number_format(($res_notas_bimestrais['at']+$res_notas_bimestrais['ap']+$res_notas_bimestrais['ab'])/3);
                ...
                <a rel="superbox[iframe][440x120]" href="scripts/detalhes_nota.php?aluno=<? echo $_GET['aluno']; ?>&amp;bimestre=3&amp;componente=96514"><? echo number_format($media);echo ",0"; $media = 0; ?></a></th>
                <th scope="col"><?
					$sql_notas = mysqli_query($conexao_bd, "SELECT * FROM notas_bimestrais WHERE aluno = '".$_GET['aluno']."' AND componente = '9621345' AND bimestre = '3'");
					  while($res_notas_bimestrais = mysqli_fetch_array($sql_notas)){
						  $media = number_format(($res_notas_bimestrais['at']+$res_notas_bimestrais['ap']+$res_notas_bimestrais['ab'])/3);
                ...
                <a rel="superbox[iframe][440x120]" href="scripts/detalhes_nota.php?aluno=<? echo $_GET['aluno']; ?>&amp;bimestre=3&amp;componente=96514"><? echo number_format($media);echo ",0"; $media = 0; ?></a></th>
                <th scope="col"><?
					$sql_notas = mysqli_query($conexao_bd, "SELECT * FROM notas_bimestrais WHERE aluno = '".$_GET['aluno']."' AND componente = '74235' AND bimestre = '3'");
					  while($res_notas_bimestrais = mysqli_fetch_array($sql_notas)){
						  $media = number_format(($res_notas_bimestrais['at']+$res_notas_bimestrais['ap']+$res_notas_bimestrais['ab'])/3);
                ...
                <a rel="superbox[iframe][440x120]" href="scripts/detalhes_nota.php?aluno=<? echo $_GET['aluno']; ?>&amp;bimestre=3&amp;componente=96514"><? echo number_format($media);echo ",0"; $media = 0; ?></a></th>
                <th width="65" scope="col"><?
					$sql_notas = mysqli_query($conexao_bd, "SELECT * FROM notas_bimestrais WHERE aluno = '".$_GET['aluno']."' AND componente = '36244' AND bimestre = '3'");
					  while($res_notas_bimestrais = mysqli_fetch_array($sql_notas)){
						  $media = number_format(($res_notas_bimestrais['at']+$res_notas_bimestrais['ap']+$res_notas_bimestrais['ab'])/3);
              ...
              <tr>
                ...
                <a rel="superbox[iframe][440x120]" href="scripts/detalhes_nota.php?aluno=<? echo $_GET['aluno']; ?>&amp;bimestre=3&amp;componente=96514"><? echo number_format($media);echo ",0"; $media = 0; ?></a></th>
                <th scope="col"><?
					$sql_notas = mysqli_query($conexao_bd, "SELECT * FROM notas_bimestrais WHERE aluno = '".$_GET['aluno']."' AND componente = '96461' AND bimestre = '4'");
					  while($res_notas_bimestrais = mysqli_fetch_array($sql_notas)){
						  $media = number_format(($res_notas_bimestrais['at']+$res_notas_bimestrais['ap']+$res_notas_bimestrais['ab'])/3);
                ...
                <a rel="superbox[iframe][440x120]" href="scripts/detalhes_nota.php?aluno=<? echo $_GET['aluno']; ?>&amp;bimestre=3&amp;componente=96514"><? echo number_format($media);echo ",0"; $media = 0; ?></a></th>
                <th scope="col"><?
					$sql_notas = mysqli_query($conexao_bd, "SELECT * FROM notas_bimestrais WHERE aluno = '".$_GET['aluno']."' AND componente = '390341' AND bimestre = '4'");
					  while($res_notas_bimestrais = mysqli_fetch_array($sql_notas)){
						  $media = number_format(($res_notas_bimestrais['at']+$res_notas_bimestrais['ap']+$res_notas_bimestrais['ab'])/3);
                ...
                <a rel="superbox[iframe][440x120]" href="scripts/detalhes_nota.php?aluno=<? echo $_GET['aluno']; ?>&amp;bimestre=3&amp;componente=96514"><? echo number_format($media);echo ",0"; $media = 0; ?></a></th>
                <th scope="col"><?
					$sql_notas = mysqli_query($conexao_bd, "SELECT * FROM notas_bimestrais WHERE aluno = '".$_GET['aluno']."' AND componente = '99981' AND bimestre = '4'");
					  while($res_notas_bimestrais = mysqli_fetch_array($sql_notas)){
						  $media = number_format(($res_notas_bimestrais['at']+$res_notas_bimestrais['ap']+$res_notas_bimestrais['ab'])/3);
                ...
                <a rel="superbox[iframe][440x120]" href="scripts/detalhes_nota.php?aluno=<? echo $_GET['aluno']; ?>&amp;bimestre=3&amp;componente=96514"><? echo number_format($media);echo ",0"; $media = 0; ?></a></th>
                <th scope="col"><?
					$sql_notas = mysqli_query($conexao_bd, "SELECT * FROM notas_bimestrais WHERE aluno = '".$_GET['aluno']."' AND componente = '9621345' AND bimestre = '4'");
					  while($res_notas_bimestrais = mysqli_fetch_array($sql_notas)){
						  $media = number_format(($res_notas_bimestrais['at']+$res_notas_bimestrais['ap']+$res_notas_bimestrais['ab'])/3);
                ...
                <a rel="superbox[iframe][440x120]" href="scripts/detalhes_nota.php?aluno=<? echo $_GET['aluno']; ?>&amp;bimestre=3&amp;componente=96514"><? echo number_format($media);echo ",0"; $media = 0; ?></a></th>
                <th scope="col"><?
					$sql_notas = mysqli_query($conexao_bd, "SELECT * FROM notas_bimestrais WHERE aluno = '".$_GET['aluno']."' AND componente = '74235' AND bimestre = '4'");
					  while($res_notas_bimestrais = mysqli_fetch_array($sql_notas)){
						  $media = number_format(($res_notas_bimestrais['at']+$res_notas_bimestrais['ap']+$res_notas_bimestrais['ab'])/3);
                ...
                <a rel="superbox[iframe][440x120]" href="scripts/detalhes_nota.php?aluno=<? echo $_GET['aluno']; ?>&amp;bimestre=3&amp;componente=96514"><? echo number_format($media);echo ",0"; $media = 0; ?></a></th>
                <th scope="col"><?
					$sql_notas = mysqli_query($conexao_bd, "SELECT * FROM notas_bimestrais WHERE aluno = '".$_GET['aluno']."' AND componente = '36244' AND bimestre = '4'");
					  while($res_notas_bimestrais = mysqli_fetch_array($sql_notas)){
						  $media = number_format(($res_notas_bimestrais['at']+$res_notas_bimestrais['ap']+$res_notas_bimestrais['ab'])/3);
