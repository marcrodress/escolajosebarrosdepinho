...
<br />
<input type="text" id="texto" style="font:12px Arial, Helvetica, sans-serif; padding:5px; width:200px;" value="http://ikuly.com/professor/arquivos/<? echo $res_fotos['foto']; ?>" readonly="readonly" />
