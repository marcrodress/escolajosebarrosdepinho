...
<? if(@$_GET['p'] == '1'){ ?>
<form action="../pdf/redireciona3.php?componente=<? echo $_GET['componente']; ?>&turma=<? echo $_GET['turma']; ?>&operador=<? echo $_GET['operador']; ?>&mes=" method="post" enctype="multipart/form-data" name="" target="_blank">
...
<a style="background:#090; text-decoration:none; padding:5px; color:#FFF; font:12px Arial, Helvetica, sans-serif;" href="mes_descricao.php?turma=<? echo $_GET['turma']; ?>&operador=<? echo $_GET['operador']; ?>">Voltar</a>
<? } ?>
</body>
</html>