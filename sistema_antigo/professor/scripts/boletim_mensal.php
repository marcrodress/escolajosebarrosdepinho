  ...
  <div class="container">
    <div class="row">
      ...
      <table class="table table-striped" border="1">
        <thead>
          <tr>
            <th width="13%" scope="col"><img src="https://upload.wikimedia.org/wikipedia/commons/2/24/Brasao_sao_goncalo_do_amarante_ce.JPG" alt="" width="120" height="100" /></th>
            <th colspan="4" align="center" scope="col"><h2>RELAT&Oacute;RIO MENSAL DE ALUNO</h2>
            <p>&nbsp;</p></th>
          </tr>
        </thead>
        <tbody>
...
<?
          ...
          <thead>
            <tr>
              ...
              <th width="35%" scope="col">OBJETIVO</th>
          ...
          <? while($res_atividades = mysqli_fetch_array($sql_atividades)){ $i++;?>
            <tr>
              ...
              <td><? echo $res_atividades['habilidade']; ?></td>
              <td><? echo $res_atividades['objetivo']; ?></td>
              ...
              <? $enviado = 0; $nota = 0; $data_entrega = 0; $total_questao = 0; $certo = 0;
               if($res_atividades['tipo_envio'] == 'arquivo'){
				   $enviados = mysqli_query($conexao_bd, "SELECT * FROM atividades_enviadas WHERE code_atividade = '".$res_atividades['code_atividade']."' AND code_aluno = '".$_GET['aluno']."' AND data != ''");
