...
<? if(isset($_POST['enviar'])){
	...
	echo "<script language='javascript'>window.location='?p=1&aluno=$aluno&turma=$turma&componente=$componente&operador=$professor';</script>";

}?>
<form action="../pdf/redireciona6.php?componente=<? echo $_GET['componente']; ?>&turma=<? echo $_GET['turma']; ?>&operador=<? echo $_GET['operador']; ?>&mes=" method="post" enctype="multipart/form-data" name="" target="_blank">
...
<? if(@$_GET['p'] == '1'){ ?>
<form action="" method="post" enctype="multipart/form-data" name="" target="_blank">
