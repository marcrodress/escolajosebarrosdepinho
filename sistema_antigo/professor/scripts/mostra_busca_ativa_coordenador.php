...
<?
require "../../conexao.php";
$sql_busca = mysqli_query($conexao_bd, "SELECT * FROM busca_ativa_coodenacao WHERE aluno = '".$_GET['aluno']."'");
if(mysqli_num_rows($sql_busca) == ''){
	echo "<p class='text-primary'>Ainda não foi realizado busca ativa para esse professor!</p>";
}else{
?>
<h6 class="text-success"><strong>Busca realizada pela gestão escolar</strong></h6>
