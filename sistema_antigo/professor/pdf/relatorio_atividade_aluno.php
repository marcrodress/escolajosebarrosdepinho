            ...
            <tr>
              ...
              <? 
				...
				while($res_atividades = mysqli_fetch_array($sql_atividades)){
					...
					$sql_arquivo = mysqli_query($conexao_bd, "SELECT * FROM atividades_enviadas WHERE code_aluno = '".$res_alunos['code_aluno']."' AND code_atividade = '".$res_atividades['code_atividade']."'");
              ...
              <th scope="col">
			    <? if($enviado == 1){ ?> <a href="#" onclick="javascript:abrirJanela('mostrar_atividade.php?arquivo_artividade=<? echo $arquivo_atividade; ?>&aluno=<? echo $res_alunos['code_aluno']; ?>&atividade=<? echo $res_atividades['code_atividade']; ?>', 900, 600);"><img src="../img/correto_atividade.png" width="25" height="25" /><? if($status_envio == 'AGUARDA'){ ?>.<? } ?></a>
			    <? }elseif($enviado == 2){ ?><a href="#" onclick="javascript:abrirJanela('mostrar_atividade.php?arquivo_artividade=<? echo $arquivo_atividade; ?>&aluno=<? echo $res_alunos['code_aluno']; ?>&atividade=<? echo $res_atividades['code_atividade']; ?>', 900, 600);"><img src="../img/olho_nao.fw.png" title="<?
                     
					 $sql_visualiza = mysqli_query($conexao_bd, "SELECT * FROM visualiza_atividade WHERE atividade = '".$res_atividades['id']."' AND aluno = '".$res_alunos['code_aluno']."'");
			    ...
			    <? }else{ ?>
                <a href="#" onclick="javascript:abrirJanela('mostrar_atividade.php?arquivo_artividade=<? echo $arquivo_atividade; ?>&aluno=<? echo $res_alunos['code_aluno']; ?>&atividade=<? echo $res_atividades['code_atividade']; ?>', 900, 600);"><img src="../img/errado_atividade.png" width="25" height="25" /></a><? } ?>
              </th>
