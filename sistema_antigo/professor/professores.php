...
<div class="container_tuod">
    <div class="container">
      <div class="row">
        <div class="col-sm">
        <a style="margin:5px 0 0 0;" rel="superbox[iframe][370x320]" href="scripts/professores.php?operador=<? echo $operador; ?>" class="btn btn-success">Cadastrar professor</a>
        <hr />
        <p class="h4 text-primary">Professores cadastrados</p>
