...
<div class="container_tuod">
    <div class="container">
      <div class="row" style="font:10px Arial, Helvetica, sans-serif;">
        <div class="col-sm">
        <br />
        <p class="h4 text-primary"><strong>Alunos com baixa frequência</strong></p>
        ...
        <thead class="thead-light">
            <tr>
              <th colspan="12" scope="col" align="center"><h5 style="padding:0; margin:0;" align="center"><strong>ALUNOS COM RISCO DE EVAS&Atilde;O: 
