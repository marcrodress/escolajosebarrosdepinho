...
<div class="container_tuod"> 
    <div class="container">
      <div class="row" style="font:10px Arial, Helvetica, sans-serif;">
        ...
        <p class="h5 text-primary"><strong>Consulta de planos de aula - ANOS FINAIS</strong></p>
        <hr />
           ...
           <form name="form" id="form">
            <select class="form-control" name="jumpMenu" id="jumpMenu" onchange="MM_jumpMenu('parent',this,0)">
			 ...
			 ?>
              <option value="?p=consultar_planos_finais&ano=<? echo $res_turmas['code_turma']; ?>&componente=<? echo $_GET['componente']; ?>&mes=<? echo $_GET['mes']; ?>"><? echo $res_turmas['code_serie']; ?>° ANO - TURMA: <? echo $res_turmas['tipo_turma']; ?> - TURNO: <? echo $res_turmas['turno']; ?></option>
              <? } ?>
            </select>
          </form>
                </form></td>
                <td><select name="jumpMenu2" class="form-control" id="jumpMenu2" onchange="MM_jumpMenu('parent',this,0)">
					...
					?>
                  <option value="?p=consultar_planos_finais&ano=<? echo $_GET['ano']; ?>&componente=<? echo $res_disciplinas['code']; ?>&mes=<? echo $_GET['mes']; ?>"><? echo $res_disciplinas['componente']; ?></option>
                  	<? } ?>
               </select></td>
                <td><select name="jumpMenu2" size="1" class="form-control" id="jumpMenu2" onchange="MM_jumpMenu('parent',this,0)">
                  <option value=""></option>
                  <option value="?p=consultar_planos_finais&ano=<? echo $_GET['ano']; ?>&componente=<? echo $_GET['componente']; ?>&mes=01">JANEIRO</option>
                  <option value="?p=consultar_planos_finais&ano=<? echo $_GET['ano']; ?>&componente=<? echo $_GET['componente']; ?>&mes=02">FEVEREIRO</option>
                  <option value="?p=consultar_planos_finais&ano=<? echo $_GET['ano']; ?>&componente=<? echo $_GET['componente']; ?>&mes=03">MAR&Ccedil;O</option>
                  <option value="?p=consultar_planos_finais&ano=<? echo $_GET['ano']; ?>&componente=<? echo $_GET['componente']; ?>&mes=04">ABRIL</option>
                  <option value="?p=consultar_planos_finais&ano=<? echo $_GET['ano']; ?>&componente=<? echo $_GET['componente']; ?>&mes=05">MAIO</option>
                  <option value="?p=consultar_planos_finais&ano=<? echo $_GET['ano']; ?>&componente=<? echo $_GET['componente']; ?>&mes=06">JUNHO</option>
                  <option value="?p=consultar_planos_finais&ano=<? echo $_GET['ano']; ?>&componente=<? echo $_GET['componente']; ?>&mes=07">JULHO</option>
                  <option value="?p=consultar_planos_finais&ano=<? echo $_GET['ano']; ?>&componente=<? echo $_GET['componente']; ?>&mes=08">AGOSTO</option>
                  <option value="?p=consultar_planos_finais&ano=<? echo $_GET['ano']; ?>&componente=<? echo $_GET['componente']; ?>&mes=09">SETEMBRO</option>
                  <option value="?p=consultar_planos_finais&ano=<? echo $_GET['ano']; ?>&componente=<? echo $_GET['componente']; ?>&mes=10">OUTUBRO</option>
                  <option value="?p=consultar_planos_finais&ano=<? echo $_GET['ano']; ?>&componente=<? echo $_GET['componente']; ?>&mes=11">NOVEMBRO</option>
                  <option value="?p=consultar_planos_finais&ano=<? echo $_GET['ano']; ?>&componente=<? echo $_GET['componente']; ?>&mes=12">DEZEMBRO</option>
				    <?
					 $sql_disciplinas = mysqli_query($conexao_bd, "SELECT * FROM disciplinas");
					  while($res_disciplinas = mysqli_fetch_array($sql_disciplinas)){
					?>
          ...
          <thead>
            <tr>
              ...
              <th scope="col" align="right"><a style="float:right;" href="pdf/relatorio_atividade_aluno.php?turma=<? echo $_GET['ano']; ?>&componente=<? echo @$_GET['componente']; ?>&operador=<? echo $operador; ?>&mes=<? echo $_GET['mes']; ?>" target="_blank"><img src="img/impressora2.png" alt="" width="23" height="23" border="0" title="Imprimir relatório por aluno" /></a>
