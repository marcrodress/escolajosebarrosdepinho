...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
 <div class="container-fluid">
  ...
  <div class="collapse navbar-collapse" id="main_nav">
	<ul class="navbar-nav">
		<li class="nav-item dropdown">
			<a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown"> PEDAGÓGICO </a>
		    <ul class="dropdown-menu">
                     ...
                     <ul class="submenu dropdown-menu">
                        <li><a class="dropdown-item">Plano de aula</a>
                     		<ul class="submenu dropdown-menu">
		                        ...
		                        <li><a class="dropdown-item" href="?p=consultar_planos_finais">Consulta de planos de aula</a></li>                                
		                    </ul>
                        </li>
			 ...
			 <!--
              ...
              <li><a class="dropdown-item" href="?p=disciplinas">Disciplinas</a></li>
