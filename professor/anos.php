        ...
        <table class="table table-striped" style="border:1px solid #000;">
		  ...
		  ?>
            <tr>
              ...
              <td align="center"><? echo mysqli_num_rows(mysqli_query($conexao_bd, "SELECT * FROM turmas_alunos WHERE turma = '".$res['code_turma']."' AND laudado = 'SIM' AND status = 'Ativo'"));?></td>
            ...
            <a rel="superbox[iframe][500x400]" href="scripts/ano_descricao.php?turma=<? echo $res['code_turma']; ?>&operador=<? echo $operador ?>"><img src="../img/lista_atividades.png" width="20" height="20" border="0" title="Imprimir relatório de atividades do ano" /></a>
            ...
            <a rel="superbox[iframe][680x450]" href="scripts/cargaHoraria.php?turma=<? echo $res['code_turma']; ?>&operador=<? echo $operador ?>"><img src="../img/cargaHorariaIcone.png" width="20" height="20" /></a>
            ...
            <tr>
              ...
              <tbody>
              <? $i = 0;
			   $sql_turma_alunos = mysqli_query($conexao_bd, "SELECT * FROM turmas_alunos WHERE turma = '".$_GET['turma']."' AND status != 'CANCCELADO'");
			  ...
			  ?>
                <tr bgcolor="#FFEADF">
                  <th align="center" scope="row"><? echo $i; ?></th>
                  <td><? echo strtoupper($res_alunos['nome_aluno']); ?> 
                     ...
                     <? if($res_turma_alunos['suprido'] == 'SIM'){ ?> <img src="../img/suprido.png" width="20" height="10" /> <? } ?>
					  ...
					  <? if($res_turma_alunos['laudado'] == 'SIM'){ ?> <img src="img/roxo.fw.png" width="10" height="10" title="<?
                        $sql_aee = mysqli_query($conexao_bd, "SELECT * FROM aee_descricao WHERE aluno = '".$res_turma_alunos['aluno']."'");
                     ...
                     ,
                     <a rel="superbox[iframe][350x500]" href="scripts/associar_aluno_comunidade.php?aluno=<? echo $res_turma_alunos['aluno']; ?>"><img src="../img/onibus.png" width="20" height="20" border="0" /></a></td>
...
%</td>
                  <td>
                    ...
                    <a rel="superbox[iframe][350x350]" href="scripts/lancar_atividades_impressas.php?aluno=<? echo $res_alunos['code_aluno']; ?>&turma=<? echo $_GET['turma']; ?>&bimestre=1"><img src="../img/atividade_impressa.png" width="20" height="20" border="0" title="Lançar notas e frequência de atividades impressas" /> </a>
                    
                     <a rel="superbox[iframe][400x600]" href="scripts/lancar_atividades_impressas2.php?aluno=<? echo $res_alunos['code_aluno']; ?>&turma=<? echo $_GET['turma']; ?>&bimestre=1"><img title="Lançar notas de transferências" src="img/notas.fw.png" width="20" height="20" /></a></td>
                </tr>
              <? }} ?>
              </tbody>
            </table>
         ...
         <? } ?>
                     <tr>
              <th colspan="12" align="center" scope="col"><strong>Total de alunos matriculados: </strong><? echo $i; ?> alunos</th>
            </tr>
