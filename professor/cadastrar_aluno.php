          ...
          <? 
           ...
           $sql = mysqli_query($conexao_bd, "SELECT * FROM alunos WHERE code_aluno = '$code_aluno'");
		     while($res_sql = mysqli_fetch_array($sql)){
				...
				$ponto_referencia = $res_sql['ponto_referencia'];
            ...
            <table width="1000" border="1" class="table">
             <thead class="thead-dark">
              ...
              <tr>
                ...
                <th align="center">PONTO DE REFER&Ecirc;NCIA</th>
                <th align="center">&nbsp;</th>
                <th align="center">&nbsp;</th>
              </tr>
              <tr>
                ...
                <td align="center"><select class="form-control" style="font:12px Arial, Helvetica, sans-serif; padding:5px; width:265px;" name="localidade" size="1">
                  <option value="<? echo $localidade; ?>"><?
				   $sql_comunidade = mysqli_query($conexao_bd, "SELECT * FROM rotas_escolares WHERE code = '$localidade'");
				    while($res_comunidade = mysqli_fetch_array($sql_comunidade)){
						echo $res_comunidade['rota'];
					}
				  ?></option>
                  ...
                  <?
				   $sql_comunidade = mysqli_query($conexao_bd, "SELECT * FROM rotas_escolares WHERE code != '$localidade'");
				    while($res_comunidade = mysqli_fetch_array($sql_comunidade)){
				  ?>
                  <option value="<? echo $res_comunidade['code']; ?>"><? echo $res_comunidade['rota']; ?></option>
                  <? } ?>
                </select>
				</td>
                <td align="center"><label for="ponto_referencia"></label>
                <input type="text" name="ponto_referencia" value="<? echo $ponto_referencia; ?>" style="border:1px solid #CCC; padding:5px; width:210px;"/></td>
                <td align="center">&nbsp;</td>
                <td align="center">&nbsp;</td>
              </tr>
              <tr>
