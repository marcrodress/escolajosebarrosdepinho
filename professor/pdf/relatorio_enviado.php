    ...
    <div class="container">
      <div class="row">
        ...
        <table class="table table-striped" border="1">
          <thead>
            <tr>
              <th width="13%" align="center" scope="col"><img src="../../img/logo.png" alt="" width="81" height="77" /></th>
        ...
        <table class="table table-striped table-hover" border="1">
           <thead>
            <tr>
              <th width="16%" scope="col" align="center">STATUS</th>
              <th width="12%" scope="col" align="center">N° CHAMADA</th>
              <th width="37%" scope="col">NOME</th>
              <th width="11%" scope="col" align="center">PRESENTE</th>
              <th width="11%" scope="col" align="center">ATIVIDADE</th>
              <th width="14%" align="center" scope="col">NOTA</th>
             </tr>
          </thead>
          
          <tbody>
          <? $i = 0;
		  $sql_alunos = mysqli_query($conexao_bd, "SELECT * FROM turmas_alunos WHERE turma = '$turma'");
		  ...
		  while($res_aluno = mysqli_fetch_array($sql_aluno)){ $i++;
		  $aluno = 0;
		  ...
		  ?>
            <tr>
			  ...
			  ?>
              <th  align="center"scope="row" <? if(mysqli_num_rows($sql_data) == '' || $status_envio == NULL){ ?> bgcolor="#F7C6B9" <? } ?>><? 
              ...
              <th align="center"><? echo $res_alunos['n_chamada']; ?></th>
              <td><? echo $res_aluno['nome_aluno']; ?></td>
