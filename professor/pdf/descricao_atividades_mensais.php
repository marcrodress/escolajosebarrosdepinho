...
<table width="676" border="0">
  <tr>
    ...
    <td colspan="2" align="center"><h1 style="font:18px Arial, Helvetica, sans-serif;"><strong>E.E.F. T. I. JOSE MARIA BARROS DE PINHO </strong></h1></td>
      ...
      <table width="700" border="0">
        <tr>
          <td colspan="2" align="center"><br />Aulas previstas: <?
		   ...
		   $sql_aulas_previstas = mysqli_query($conexao_bd, "SELECT * FROM aulas_previstas WHERE mes = '$mes_m' AND componente = '".$_GET['componente']."' AND turma = '".$_GET['turma']."'");
