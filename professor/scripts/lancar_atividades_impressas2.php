...
<? if(isset($_POST['alterar'])){
	...
	if(mysqli_num_rows($sqlBuscaNota) == ''){
		...
		mysqli_query($conexao_bd, "UPDATE notas_bimestrais SET tipo = 'COORDENACAO', at = '$nota', ap = '$nota', ab = '$nota', media = '$nota' WHERE aluno = '$aluno' AND componente = '$componente' AND bimestre = '$bimestre' AND turma = '$turma'");
