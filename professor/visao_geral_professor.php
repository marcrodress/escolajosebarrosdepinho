...
<div class="container_tuod">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col">
          <h2 style="margin:-10px 0 0 10px;"><strong><? echo strtoupper($res_colaborador['nome']); ?></strong></h2>
        ...
        <table class="table table-striped">
		  ...
		  $sql = mysqli_query($conexao_bd, "SELECT * FROM busca_ativa WHERE professor = '".$_GET['code']."' ORDER BY id DESC");
		   ...
		   while($res = mysqli_fetch_array($sql)){ $i++;
		   	  ...
		   	  $sql_aluno = mysqli_query($conexao_bd, "SELECT * FROM turmas_alunos WHERE aluno = '".$res['aluno']."'");
