...
<div class="container_tuod"> <? $turma = $_GET['turma']; $atividade = $_GET['atividade']; ?>
    <div class="container">
      <div class="row">
        ...
        <?
		$id_atividade = 0; $verifica_plano = 0;
	     ...
	     while($res_alunos = mysqli_fetch_array($sql_turma)){
		  ...
		  ?>
            <tr>
              ...
              <td id="#<? echo $res_alunos['code_aluno']; ?>"><p style="font:12px Arial, Helvetica, sans-serif;" id="#<? echo $res_alunos['code_aluno']; ?>"></a><strong><? echo strtoupper($res_alunos['nome_aluno']); ?></strong>
                  <? if($res_turmas['transferido'] == 'SIM'){ ?> <img src="../img/transferido.png" width="5" height="10" /> <? } ?>
                  <? if($res_turmas['suprido'] == 'SIM'){ ?> <img src="../img/suprido.png" width="5" height="10" /> <? } ?>
        		  <? if($res_turmas['impresso'] == 'SIM'){ ?> <img src="img/amarelo.png" width="5" height="10" /> <? } ?>
                  <? if($res_turmas['laudado'] == 'SIM'){ ?> <img src="img/roxo.fw.png" width="5" height="10" /> <? } ?>
              </p>
              </td>
              <td><?
              ...
              <input style="border:1px solid #CCC; width:50px; text-align:center; border-radius:5px;" value="<? echo $res_data['nota']; ?>" name="nota" type="number" size="5" />
