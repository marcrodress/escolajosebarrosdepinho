...
mysqli_query($conexao_bd, "INSERT INTO busca_ativa (componente, ip, data, tipo, atividade, aluno, professor, data_hora, forma_contato, anexos, feedback) VALUES ('".$_GET['componente']."', '$ip', '$data_completa', 'ATIVIDADE', '$atividade', '$aluno', '$operador', '$data_c $hora_c', '$forma_contato', '$enviar_docs', '$feedback')");

mysqli_query($conexao_bd, "INSERT INTO score (professor, tipo, pontuacao, descricao, data) VALUES ('$operador', 'CREDITO', '5', 'INFORMAÇÃO DE BUSCA ATIVA', '$data')");

	mysqli_query($conexao_bd, "INSERT INTO acao_professor (ip, data, data_completa, acao, usuario) VALUES ('$ip', '$data', '$data_completa', 'PROFESSOR $operador, INFORMOU BUSCA ATIVA DO ALUNO $aluno RELATIVO A ATIVIDADE $atividade', '$operador')");
