...
if($fase == 'ANOS FINAIS'){
	$sql_plano_finais = mysqli_query($conexao_bd, "SELECT * FROM plano_de_aula WHERE id_aula = '$id'");
	 while($res_plano_finais = mysqli_fetch_array($sql_plano_finais)){
		 ...
		 $abertura_mensagem = $res_plano_finais['abertura_mensagem'];
		 $abertura_objetivo = $res_plano_finais['abertura_objetivo'];
		 $abertura_exemplifique = $res_plano_finais['abertura_exemplifique'];
		 $sequencia_slide = $res_plano_finais['sequencia_slide'];
		 $sequencia_estudo = $res_plano_finais['sequencia_estudo'];
		 $sequencia_audios = $res_plano_finais['sequencia_audios'];
		 $sequencia_exposicao = $res_plano_finais['sequencia_exposicao'];
		 $sequencia_redes = $res_plano_finais['sequencia_redes'];
		 $sequencia_pesquisa = $res_plano_finais['sequencia_pesquisa'];
		 $sequencia_web = $res_plano_finais['sequencia_web'];
		 ...
		 $fechamento_exercicios = $res_plano_finais['fechamento_exercicios'];
		 $fechamento_atividade_docente = $res_plano_finais['fechamento_atividade_docente'];
		 $fechamento_exemplifique = $res_plano_finais['fechamento_exemplifique'];
		 $recursos_mesa = $res_plano_finais['recursos_mesa'];
