...
mysqli_query($conexao_bd, "UPDATE alunos SET transferido = '$transferido', onibus = '$onibus', suprido = '$suprido', turma = '$turma', localidade = '$localidade', n_chamada = '$n_chamada', nome_aluno = '$nome_aluno', telefone = '$telefone', telefone2 = '$telefone2', especial = '$laudo', impresso = '$impresso' WHERE code_aluno = '$aluno'");
...
<input name="onibus" type="checkbox" style="width:20px;" value="SIM" <? if($res_aluno['onibus'] == 'SIM'){ ?>checked="checked"<? } ?> /> Depende do onibus
<hr />
