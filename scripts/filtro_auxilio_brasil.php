...
<form name="form" id="form">
  <select name="jumpMenu" id="jumpMenu" onchange="MM_jumpMenu('parent',this,0)">
	...
	?>
    <option value="../?p=infrequencia_auxilio_brasil&inicio=<? echo $_GET['inicio']; ?>&final=<? echo $_GET['final']; ?>&turma=<? echo $res_turma['code_turma']; ?>"><? echo $res_turma['fase']; ?>: <? echo $res_turma['code_serie']; ?>°: <? echo $res_turma['tipo_turma']; ?> - <? echo $res_turma['turno']; ?> - Sala: <? echo $res_turma['sala']; ?></option>
    <? } ?>
  </select>
</form>
<? } ?>
