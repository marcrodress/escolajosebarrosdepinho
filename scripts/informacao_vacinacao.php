...
mysqli_query($conexao_bd, "INSERT INTO vacinacao (cpf, tipo_vacina, data_aplicacao, lote, cod, nome_aplicador, local_aplicacao, regional_prof, n_dose, comprovante, nome_vacina, fabricante) VALUES ('$cpf', '$vacina', '$data_aplicacao', '$lote', '$cod', '$nome_aplicador', '$local_aplicacao', '$reg', '$dose', '$comprovante', '$nome_vacina', '$fabricante')");
...
<hr />
<?
$sql = mysqli_query($conexao_bd, "SELECT * FROM vacinacao WHERE cpf = '".$_GET['cpf']."'");
...
mysqli_query($conexao_bd, "DELETE FROM vacinacao WHERE id = '$id'");
