...
mysqli_query($conexao_bd, "INSERT INTO documentos_colaboradores (cpf, tipo, documento, comprovante) VALUES ('$cpf', '$tipo_documento', '$nome_documento', '$comprovante')");
...
<?
$sql_documentacao = mysqli_query($conexao_bd, "SELECT * FROM documentos_colaboradores WHERE cpf = '".$_GET['cpf']."'");
...
mysqli_query($conexao_bd, "DELETE FROM documentos_colaboradores WHERE id = '$id'");
