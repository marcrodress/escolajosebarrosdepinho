        ...
        <thead class="thead-light">
          ...
          <tbody>
            <tr>
              ...
              <td width="333"><strong>NOME DO ALUNO</strong></td>
              <td width="76"><strong>PORTUGU&Ecirc;S</strong></td>
              <td width="73"><strong>MATEM&Aacute;TICA</strong></td>
              <td width="55"><strong>HIST&Oacute;RIA</strong></td>
              <td width="68"><strong>GEOGRAFIA</strong></td>
              <td width="56"><strong>CI&Ecirc;NCIAS</strong></td>
              <td width="44"><strong>INGL&Ecirc;S</strong></td>
              <td width="81"><strong>ED. F&Iacute;SICA</strong></td>
              <td width="39"><strong>ARTES</strong></td>
              <td width="76"><strong>RELIGI&Atilde;O</strong></td>
              <td width="29"></td>
            </tr>
           <? $i = 0; 
          ...
          <input type="hidden" name="aluno" value="<? echo $res_1['aluno']; ?>" />
            <tr>
              ...
              <td align="center">
			  <?
			  $sql_ed_9621345 = mysqli_num_rows(mysqli_query($conexao_bd, "SELECT * FROM controle_livros WHERE ed_9621345 = 'SIM' AND turma = '$turma' AND aluno = '$aluno'"));	
			  ?>               
              <input type="checkbox" name="ed_9621345" <? if($sql_ed_9621345 >= 1){ ?> checked="checked" <? } ?> value="SIM" title="Educação Física" /></td>
              <td align="center">
			  <?
